...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '20e4466cd18040008f51ab9d84a61d7e',
...
AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '张M', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的物理老师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://mwuli.com', // 网站地址 
